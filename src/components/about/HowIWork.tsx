...
interface Principle {
  ...
  },
  {
    ...
    description: "Staying ahead of technology trends and actively exploring new research to push the boundaries of what's possible."
  },
  {
    icon: <Users size={24} className="text-black stroke-2" />,
    title: "Collaboration & Knowledge Sharing",
    description: "Working with teams, mentoring peers, and building clear documentation to multiply collective expertise."
  },
  {
    icon: <Zap size={24} className="text-black stroke-2" />,
    title: "Automation & Performance",
    description: "Optimizing workflows, automating repetitive tasks, and ensuring seamless user experiences through high-performance solutions."
  }
];
