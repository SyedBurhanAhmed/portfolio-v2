  ...
  return (
    <div className="mb-12">
      <div className="flex justify-center">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-3 px-4 sm:px-6 py-4 sm:py-3 bg-primary/5 border border-primary/20 rounded-2xl sm:rounded-full max-w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-sm">
            ...
            <span className="text-primary font-medium text-center sm:text-left">
